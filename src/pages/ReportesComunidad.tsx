...
const MOCK_REPORTS: Report[] = [
  { id: "r1", titulo: "Pérdida de internet", categoria: "Sistemas", subcategoria: "Redes", estado: "Rechazado", descripcion: "Cortes frecuentes de conectividad en la biblioteca.", votos: 12, fecha: "2025-11-09", evidencias: ["/mnt/data/0695693f-6b6a-4c6a-9583-67504729d547.png"] },
  { id: "r2", titulo: "Aire acondicionado fallando", categoria: "Mantenimiento", subcategoria: "Climatización", estado: "Pendiente", descripcion: "El salón 204 no enfría bien. Huele raro.", votos: 5, fecha: "2025-11-10", evidencias: ["/mnt/data/9baad3a2-0dc7-4843-a17d-895d59d0bcc1.png", "/mnt/data/0695693f-6b6a-4c6a-9583-67504729d547.png"] },
  { id: "r3", titulo: "Césped sin podar", categoria: "Mantenimiento", subcategoria: "Áreas verdes", estado: "Pendiente", descripcion: "El área verde principal no ha sido podada en meses.", votos: 1, fecha: "2025-10-25", evidencias: [] },
  { id: "r4", titulo: "Ventana rota en aula idiomas 1", categoria: "Mantenimiento", subcategoria: "Infraestructura", estado: "Abierto", descripcion: "Vidrio roto desde hace 3 días, riesgo de corte.", votos: 4, fecha: "2025-11-08", evidencias: [] },
  { id: "r5", titulo: "Ruta de camión que no pasó", categoria: "Mantenimiento", subcategoria: "Transporte", estado: "Pendiente", descripcion: "Ruta escolar no cumplió su recorrido hoy.", votos: 2, fecha: "2025-11-07", evidencias: [] },
  { id: "r6", titulo: "Problema con acceso al sistema académico", categoria: "Sistemas", subcategoria: "Software", estado: "Pendiente", descripcion: "No se puede ingresar al portal de calificaciones.", votos: 8, fecha: "2025-11-06", evidencias: [] },
  { id: "r7", titulo: "Basura acumulada junto al contenedor", categoria: "Mantenimiento", subcategoria: "Limpieza", estado: "Resuelto", descripcion: "Se recogió el mismo día, pero vuelve a ocurrir.", votos: 3, fecha: "2025-10-30", evidencias: [] },
  { id: "r8", titulo: "Fuga en laboratorio", categoria: "Mantenimiento", subcategoria: "Infraestructura", estado: "Pendiente", descripcion: "Posible fuga de agua en laboratorio B.", votos: 6, fecha: "2025-10-28", evidencias: [] },
  { id: "r9", titulo: "Luces parpadeando en aula 3", categoria: "Mantenimiento", subcategoria: "Electricidad", estado: "Pendiente", descripcion: "Intermitencia en iluminación.", votos: 0, fecha: "2025-11-02", evidencias: [] },
  { id: "r10", titulo: "Ruido extraño en ductos", categoria: "Mantenimiento", subcategoria: "Infraestructura", estado: "Pendiente", descripcion: "Ruidos por la noche en los ductos de ventilación.", votos: 0, fecha: "2025-10-22", evidencias: [] }
];
...
export default function ReportesComunidad() {
  ...
  const [comments, setComments] = useState<Record<string, string[]>>({
    r1: ["También falló en el edificio D.", "Confirmo, no hay internet desde temprano."],
    r2: ["hola", "apoco si as"],
    ...
    <div className="community-page">
      ...
      <div className="search-row">
        ...
        <label className="sort-checkbox">
          <input type="checkbox" checked={sortByVotes} onChange={() => setSortByVotes(s => !s)} />
          Priorizar por votos
        </label>
      </div>
      ...
      <main className="community-content" aria-live="polite">
        <div className="list">
          {filtered.slice(0, visibleCount).map((r) => (
            <article key={r.id} className="report-card" aria-labelledby={`title-${r.id}`}>
              <div className="card-left">
                <img src={iconFor(r.categoria)} alt={r.categoria} className="cat-icon" />
              </div>

              <div className="card-body" onClick={() => openModal(r)}>
                <h3 id={`title-${r.id}`} className="report-title">{r.titulo}</h3>
                <p className="cat-sub">
              ...
              <div className="card-right">
                <div className="vote-col">
                  <button
                    className={`vote-btn ${userVotes[r.id] === 1 ? "active" : ""}`}
                    onClick={(e) => {
                      e.stopPropagation();
                      toggleUpvote(r.id);
                    }}
        ...
        <div className="modal-backdrop" onClick={closeModal}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="detail-info">
              ...
              <p><strong>Subcategoría:</strong> {selected.subcategoria}</p>
            </div>
